import "./incomes.css";
import Incomeitemdiv from "./Incomeitemdiv";
...
const getmovies = () =>{
   ...
   return(  <React.Fragment>
      {movies.map((dataset =>(
         ...
         <Incomeitemdiv  Amount = {dataset.data.salaryAmount}  Title = {dataset.data.salaryTitle}  Reference ={dataset.data.reference} Date = {dataset.data.date}
